...
library(knitr)
library(readxl)
tooele_table <- read_xlsx("images/tooele_table.xlsx")
kable(tooele_table)
```
```{r tooeletable2, echo = FALSE}
library(knitr)
library(readxl)
tooele_table2 <- read_xlsx("images/tooele_table2.xlsx")
kable(tooele_table2)
```
...
```{r links, fig.cap="Critical Highway Links Identified using Risk Priority Analysis", out.width='100%', echo = FALSE}
#\@ref(fig:i85map)
knitr::include_graphics("images/links.png")
```
...
library(knitr)
library(readxl)
linktable <- read_xlsx("images/linktable.xlsx")
kable(linktable)
```
...
library(knitr)
library(readxl)
linktable <- read_xlsx("images/logsumrank.xlsx")
kable(logsumrank)
```
...
library(knitr)
library(readxl)
linktable <- read_xlsx("images/traveltimerank.xlsx")
kable(traveltimerank)
```
