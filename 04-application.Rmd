...
library(knitr)
library(readxl)
tooeletable <- read_xlsx("images/tooeletable.xlsx")
kable(tooeletable)
```
```{r tooeletable2, echo = FALSE}
library(knitr)
library(readxl)
tooeletable2 <- read_xlsx("images/tooele_table2.xlsx")
kable(tooeletable2)
```
...
library(knitr)
library(readxl)
logsumrank <- read_xlsx("images/logsumrank.xlsx")
kable(logsumrank)
```
...
library(knitr)
library(readxl)
traveltimerank <- read_xlsx("images/traveltimerank.xlsx")
