...
able to operate effectively with damaged or unusable links.
...
where systemically critical or vulnerable links are located will help in allocating
...
other definitions, and making distinctions between them is important
[@rogers2012]. A bridge highly vulnerable to failure may be located on a
...
define and conceptualize vulnerability by envisioning analyses conducted with
...
the network. In particular, Berdica identifieed a need for further research
