...
highway maintenance resources prior to disaster with the potential to
disrupt transport network connectivity. Each link in the sample network is
assigned a specific failure probability which decreases as funding as allocated.
The researchers evaluated changes to traversal costs between between 
...
locally optimal solution existing for invesetment allocation leading to a 
