...
engineering that hardens the system against failure [citation]; others as an
ability for maintenance staff to rapidly restore service following catastrophe
[citation]; and others as an ability for a system to continue operating in
degraded state [citation]. Regardless of the definition used, assessing the
resiliency of a transportation network --- and addressing any potential
shortfalls --- requires a method to identify which links or facilities are most
...
methods ignore that some networks have alternate routes readily available, or
